...
**Gino Aldair Maihuiri Romero** — systems engineering student and
self-directed security researcher based in Lima, Peru.

I focus on **reverse engineering, malware analysis, and exploit development**
on Linux and Windows — x86-64, ELF and PE binaries, GDB and Ghidra.

Currently:
- 🔬 Static and dynamic analysis of LockBit ransomware internals
- 🎯 Working toward OSED (EXP-301) — offensive security exploit development
- 📖 Writing three technical books on malware analysis and code obfuscation
- 🛠️ Building ptrace tooling in Rust for binary instrumentation
- 📡 Publishing YARA detection rules on YARAhub (abuse.ch)

**Tools:** Ghidra · GDB · x64dbg · YARA · Rust · Python · C/C++ · objdump
